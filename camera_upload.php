<?php include("header.php"); ?>
    ...
    <div class="camera-container">
        ...
        <div class="camera">
            <div class="camera-img" style="display:flex;">
				<div style="width:90%;">
					<p style="margin-top: 30px;" class="h1 py-md" >Upload the image rather than use your webcam</p>
					<form style="width:95%;"  class="camera-form" method="POST" action="create_camera_post.php" enctype="multipart/form-data">
						<div>
							<p style="margin-top: 30px;" class="sticker-description h4 h-5 py-md">1. First, Click on one or more stickers (Do it first, or next button won't be clickable!)</p>
						...
						<p style="margin-top: 30px;" class="sticker-description h4 h-5 py-md">2. Upload image</p>
						...
						<div style="position:relative;">
							<!-- GO TO MAKE THE UPLOADED FILE GO IN THAT CANVAS -->
	...
	<script>	
		...
		capture_button.addEventListener('click', function() {
			...
			// I NEED TO REPLACE video by img, and ensure that when I upload, img is equal to the right object
