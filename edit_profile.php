            ...
            <h3 class="text-center">Update Profile</h3>
                ...
                <form action="update_profile.php" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="password" class="form-control" name="password" id="password" placeholder="Put in a new password if you want to change it" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" minlength="8" maxlength="20" title="Must contain at least one number and one uppercase and lowercase letter, and at least 8 or more characters">
                    </div>
                    <div class="mb-3">
